...
// $(document).ready(function($) {		  
	...
	function equalize_page_columns() {
		...
		} catch (err){var sections_array_left = sections_array_center; var left_region =document.getElementById("content-column");}
		...
		} catch (err){var sections_array_right = sections_array_center; var right_region =document.getElementById("content-column");}
	...
	setTimeout(function(){equalize_page_columns()},500);
